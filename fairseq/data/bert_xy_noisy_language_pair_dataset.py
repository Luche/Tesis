...
def collate(
    ...
    origin_source = merge('origin_source', left_pad=left_pad_target)
    origin_source = origin_source.index_select(0, sort_order)
...
class BertXYNoisyLanguagePairDataset(FairseqDataset):
    ...
    def __getitem__(self, index):
        ...
        return {
            'id': index,
            'origin_source': torch.LongTensor(origin_source),
