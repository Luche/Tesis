...
def load_checkpoint(args, trainer):
    ...
    extra_state = trainer.load_checkpoint(
        ...
        use_adapter_bert=use_adapter_bert,
    )
...
def load_model_ensemble(filenames, arg_overrides=None, task=None, bert_ratio=None, encoder_ratio=None, geargs=None):
    ...
    """
    ensemble, args, _task = _load_model_ensemble(filenames, arg_overrides, task, bert_ratio, encoder_ratio, geargs)
    return ensemble, args


def _load_model_ensemble(filenames, arg_overrides=None, task=None, bert_ratio=None, encoder_ratio=None, geargs=None):
