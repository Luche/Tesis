...
def main(args):
            ...
            for i, sample_id in enumerate(sample['id'].tolist()):
                ...
                for i, hypo in enumerate(hypos[i][:min(len(hypos), args.nbest)]):
                    ...
                    if has_target and i == 0:
                        scores = scorer.score(target_str, hypo_str)
                        r1 = scores['rouge1'][2]
                        r2 = scores['rouge2'][2]
                        rl = scores['rougeL'][2]
    ...
    print('| Summarized {} sentences ({} tokens) in {:.1f}s ({:.2f} sentences/s, {:.2f} tokens/s)'.format(
        num_sentences, gen_timer.n, gen_timer.sum, num_sentences / gen_timer.sum, 1. / gen_timer.avg))
    if has_target:
        r1=mean(total_scores['r1'])
        r2=mean(total_scores['r2'])
        rl=mean(total_scores['rl'])
        print('| Generate {} with beam={}: R1={}, R2={}, RL={}'.format(
            args.gen_subset, args.beam, r1, r2, rl))
    return r1, r2, rl
